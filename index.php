...
<body style="padding: 80px; background-color:white;">
    <div class="row no-gutters rounded-4" style="height: 420px; box-shadow: 20px 20px 20px 5px rgba(0, 0, 0, 0.4);">
        <div class="col-7 rounded-start-4 bg-primary" style="color:white; background-color: green; padding:20px; text-align:center; align-items:center; justify-content:center;">
            <div style="transform: translate( 0%, 45%);">
                <h1>Selamat Datang</h1>
                <p>Selamat datang di halaman login admin data pegawai. Silahkan register jika belum memiliki akun</p><br>
                <a href="assets/pages/register.php">
                    <button type="button" class="btn btn-outline-light rounded-5" style="width: 150px;">Register</button>
                </a>
            </div>
        </div>
        <div class="col-5 rounded-end-4 login" style="background-color:#e0e0e0; ">
            <div class="login-box" style=" padding:20px; transform: translate( 0%, 20%);">
                <form action="assets/config/login.php" method="POST">
                    ...
                    <div style="text-align: center; padding: 20px;">
                        <button type="submit" name="submit" class="btn btn-outline-primary rounded-5" style="width: 75%;">Login</button>
                    </div>
                </form>
            </div>
        </div>
